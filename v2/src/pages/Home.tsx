          ...
          <div className=" grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-12 items-center">
            ...
            <div className="relative overflow-hidden">
              ...
              >
                ...
                <div
                  className="hidden w-full aspect-[4/5] bg-stone-200 rounded-lg items-center justify-center text-stone-500"
                  style={{
                    transform: `translateY(${parallaxOffset}px)`
                  }}
                >
          ...
          <div>
            ...
            <div className="flex flex-col-reverse md:flex-row gap-16">
              ...
              <div>
                ...
                />
                {/* Fallback placeholder */}
                <div className="hidden w-full aspect-[4/5] bg-stone-200 rounded-lg items-center justify-center text-stone-500">
